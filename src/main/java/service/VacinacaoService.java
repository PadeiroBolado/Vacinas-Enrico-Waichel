...
public class VacinacaoService {
	...
	public Vacinacao salvar(Vacinacao novaVacinacao) throws VacinasException {

		if(novaVacinacao.getIdPessoa() == 0 
				|| novaVacinacao.getVacina() == null
				|| novaVacinacao.getVacina().getId() == 0) {
			throw new VacinasException("Informe a o id da pessoa e a vacina da aplicação");
		}
	...
	public boolean atualizar(Vacinacao vacinacaoEditada) throws VacinasException {
